...
import { ParentCategoryFindManyArgs } from "../../parentCategory/base/ParentCategoryFindManyArgs";
import { ParentCategory } from "../../parentCategory/base/ParentCategory";
...
export class CategoryControllerBase {
  ...
  async findManyParent(
    ...
    const query = plainToClass(ParentCategoryFindManyArgs, request.query);
    const permission = this.rolesBuilder.permission({
      role: userRoles,
      action: "read",
      possession: "any",
